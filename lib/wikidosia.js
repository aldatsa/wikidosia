...
Wikidosia.prototype.txiokatuEgunekoIrakurrienak = function(hizkuntza_kodea, urtea, hilabetea, eguna, zenbat, bereziak_barne) {
    ...
    wikipedia.getMostViewedArticles(hizkuntza_kodea, urtea, hilabetea, eguna, zenbat, bereziak_barne).then(function(emaitza) {
