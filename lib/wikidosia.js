...
var Wikidosia = function (config) {
    ...
    var asteko_herriaren_txioak = schedule.scheduleJob(config.schedule_job_town_of_the_week, function() {
        ...
        if (!error && response.statusCode == 200) {
            ...
            request({
                ...
                if (!error && response.statusCode == 200) {
                    ...
                    herria.irudiak.x1 = "http:" + $("#mw-content-text .infotaula a.image img").attr("src");
                    herria.irudiak.x1_5 = "http:" + srcset[0];
                    herria.irudiak.x2 = "http:" + srcset[2];
