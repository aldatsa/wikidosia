...
/*
 * Artikulu nabarmenduak bakarrik itzultzen dituen APIrik ez dudanez aurkitu webgunetik erauziko ditut.
 */
EuskalWikipedia.prototype.eskuratuNabarmenduenZerrenda = function() {

    // 2019-08-20 Nabarmenduak zerrendatzeko modua aldatu zuten eta 2 orritan banatuta daude orain.
    // Automatizatu liteke baina bi txandatan eskuratu eta eskuz batu ditut nabarmenduak.json fitxategian. Gero desordenatu_nabarmenduak.js script-a exekutatu dut.
    var url = "https://eu.wikipedia.org/wiki/Kategoria:Artikulu_nabarmenduak";
    //var url = "https://eu.wikipedia.org/w/index.php?title=Kategoria:Artikulu_nabarmenduak&pagefrom=Peron%2C+Eva%0AEva+Per%C3%B3n";
    ...
    var promise = new Promise(function(resolve, reject) {
        ...
        request({
            ...
            if (!error && response.statusCode == 200) {
                ...
                estekak = $("#mw-pages .mw-content-ltr .mw-category-group ul li a");
